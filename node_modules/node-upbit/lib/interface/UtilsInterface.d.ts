...
export default interface UtilsInterface {
    getOhlcav: (type: TCandle, market: string, count: number, to?: string) => Promise<IOhlcavProps[]>;
    getOhlcvPlusOne: (type: TCandle, market: string, count: number, to?: string) => Promise<IOhlcavProps[]>;
